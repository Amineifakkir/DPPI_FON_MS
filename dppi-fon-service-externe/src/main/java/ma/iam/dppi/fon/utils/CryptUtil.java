...
public class CryptUtil {
	...
	public CryptUtil(String pswdLdap) throws DppiFonException {
	...
	public static String encrypt(String data) throws DppiFonException {
		...
		try {
			...
			e.getMessage();
			throw new DppiFonException(ErrorCodeEnum.ERROR_PSW, "Probleme encrypt password");

		}
		return encryptedValue;
	}

	public static String decrypt(String encryptedData) throws DppiFonException {
		...
		try {
			...
			e.getMessage();
			throw new DppiFonException(ErrorCodeEnum.ERROR_PSW, "Probleme decrypt Password");
