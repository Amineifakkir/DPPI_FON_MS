...
//
//import ma.iam.dppi.domain.ImportHistory;
//import ma.iam.dppi.exception.AppException;
//import ma.iam.dppi.exception.ErrorCodeEnum;
//import ma.iam.dppi.exception.UnsupportedFileNameException;
//import ma.iam.dppi.exception.UnsupportedFileTypeException;
//
...
//	}
//
//	public String getValue(ExcelParserInfo parserInfo, int cellNum, String columnName) throws AppException {
//		String value = null;
//		try {
...
//			throw new AppException(ErrorCodeEnum.ALPHA_NUM_ERR,
//					"La valeur de la colonne " + columnName + " doit être une chaine de caractères");
//		}
//		return value;
//	}
//	
//	public Double getGpsValue(ExcelParserInfo parserInfo, int cellNum, String columnName) throws AppException {
//		Double value = null;
//		try {
...
//	}
//	
//	public Integer getIntegerValue(ExcelParserInfo parserInfo, int cellNum, String columnName) throws AppException {
//		Integer value = null;
//		try {
