...
public class SecondaryConfig {
	...
	@Bean(name = "dppiFonDataSource")
    public DataSource dppiFonDataSource() {
	...
	public LocalContainerEntityManagerFactoryBean dppiFonEntityManager() throws Throwable {
		...
		entityManager.setJtaDataSource(dppiFonDataSource());
		entityManager.setJpaVendorAdapter(jpaVendorAdapter);
		entityManager.setPackagesToScan("ma.iam.dppi.fon.domain");
		entityManager.setPersistenceUnitName("dppiFonPersistenceUnit");
