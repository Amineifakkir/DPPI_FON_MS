...
public class DateUtils {
	...
	public static String dateToStringDateSlash(Date date) {
		DateFormat df = new SimpleDateFormat("dd/MM/yyyy");
		return df.format(date);
	}
	
	public static String dateToStringTimeComplet(Date date) {
	...
	public static Date dateFromDateString(String dateStr) {
		Date date = null;
		try {
