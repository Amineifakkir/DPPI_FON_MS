...
import ma.iam.dppi.fon.interne.exception.UnsupportedFileTypeException;
...
public class ExcelHelper {
	...
	public String getValue(ExcelParserInfo parserInfo, int cellNum, String columnName) throws DppiGcException {
		String value = null;
		try {
			...
			throw new DppiGcException(ErrorCodeEnum.ALPHA_NUM_ERR,
					"La valeur de la colonne " + columnName + " doit être une chaine de caractères");
		}
		return value;
	}
	
	public Integer getIntegerValue(ExcelParserInfo parserInfo, int cellNum, String columnName) throws DppiGcException {
		Integer value = null;
		try {
